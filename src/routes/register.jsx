  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        "https://scrim-api-production.up.railway.app/register",
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center w-full">
        <Dialog
          open={isOpenPleaseFill}
          onClose={(val) => setIsOpenPleaseFill(val)}
          static={true}
        >
          <DialogPanel>
            ...
            <Button
              ...
              onClick={() => setIsOpenPleaseFill(false)}
            >
              Got it!
            </Button>
          </DialogPanel>
        ...
        <Dialog
          open={isOpenSuccess}
          onClose={(val) => setIsOpenSuccess(val)}
          static={true}
        >
          <DialogPanel>
            <h3 className="text-lg font-semibold text-tremor-content-strong dark:text-dark-tremor-content-strong">
        ...
        <Dialog
          open={isOpenError}
          onClose={(val) => setIsOpenError(val)}
          static={true}
        >
          <DialogPanel>
            <h3 className="text-lg font-semibold text-tremor-content-strong dark:text-dark-tremor-content-strong">
